...
/*
    README: use contains method not HashMap :D
 */
/**
...
public class MyList<Integer> extends ArrayList<Integer> {
    ...
    private HashMap<Integer, java.lang.Integer> occ;

    public MyList() {
        differentElements = 0;
        occ = new HashMap<Integer, java.lang.Integer>();
    }
